...
export function PlayingCard({ card, hidden }: PlayingCardProps) {
  if (hidden || !card) {
    return (
      <div className="flex h-24 w-16 shrink-0 items-center justify-center rounded-lg border-2 border-[#FFD700]/50 bg-gradient-to-br from-[#0056b3] to-[#003366] shadow-lg sm:h-28 sm:w-20">
  ...
  return (
    <div className="flex h-24 w-16 shrink-0 flex-col justify-between rounded-lg border border-white/20 bg-white p-2 shadow-lg sm:h-28 sm:w-20">
      <span
